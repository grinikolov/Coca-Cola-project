        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimesRated = table.Column<int>(nullable: false, defaultValue: 0),
                    ImageSrc = table.Column<string>(nullable: true),
                    IsDeleted = table.Column<bool>(nullable: false, defaultValue: false),
                    IsAlcoholic = table.Column<bool>(nullable: false, defaultValue: false),
                    Instructions = table.Column<string>(nullable: false, defaultValue: "Mix all ingredients.")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Parts = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CocktailBars", x => new { x.BarId, x.CocktailId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CocktailBars_CocktailId",
                table: "CocktailBars",
                column: "CocktailId");
